...
## OWASP Top 10 (referência base)

1. Broken Access Control — verifique se toda rota administrativa tem @PreAuthorize
2. Cryptographic Failures — dados sensíveis em trânsito (HTTPS) e em repouso (AES-256)
3. Injection — SQL, NoSQL, OS command, template injection em toda entrada do usuário
...
8. Software & Data Integrity — CI/CD seguro, assinatura de artefatos
9. Logging & Monitoring — logs de auth, transações e erros com trace_id
